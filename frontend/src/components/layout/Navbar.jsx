          ...
          <>
            <Button onClick={handleUsernameClick}>
              ...
              <svg className="icon" width="20" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"> 
                <path d="M12.6636 13.9966V12.6636C12.6636 11.9565 12.3827 11.2784 11.8827 10.7784C11.3827 10.2784 10.7046 9.99756 9.99756 9.99756H5.99854C5.29146 9.99756 4.61335 10.2784 4.11338 10.7784C3.6134 11.2784 3.33252 11.9565 3.33252 12.6636V13.9966" stroke="#F54900" stroke-width="1.33301" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M7.99805 7.33154C9.47045 7.33154 10.6641 6.13793 10.6641 4.66553C10.6641 3.19313 9.47045 1.99951 7.99805 1.99951C6.52565 1.99951 5.33203 3.19313 5.33203 4.66553C5.33203 6.13793 6.52565 7.33154 7.99805 7.33154Z" stroke="#F54900" stroke-width="1.33301" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              ...
              <svg className= {`arrow ${dropDown ? "open" : ""}`} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.99902 5.99854L7.99805 9.99756L11.9971 5.99854" stroke="#F54900" stroke-width="1.33301" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
