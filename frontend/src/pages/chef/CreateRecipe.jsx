          ...
          <div className="chef-form-main">
            <article className="chef-card">
              ...
              <div className="chef-form-grid">
                <label className="chef-field chef-field-full">
                  ...
                  <input type="text" defaultValue="e.g. Classic Spaghetti Carbonara" />
                </label>
                ...
                <label className="chef-field chef-field-full">
                  ...
                  <textarea
                    rows="4"
                    defaultValue="Brief description of your recipe..."
                  />
                </label>

                <label className="chef-field">
                  <span>Cuisine *</span>
                  <input type="text" defaultValue="Italian" />
                </label>

                <label className="chef-field">
                  <span>Meal Type *</span>
                  <input type="text" defaultValue="Main Course" />
                </label>
                ...
                <label className="chef-field">
                  ...
                  <input type="text" defaultValue="450" />
                </label>
              </div>
            </article>
            ...
            <article className="chef-card">
              ...
              <div className="chef-dynamic-row">
                ...
                <input type="text" defaultValue="Unit" />
              </div>
            </article>
            ...
            <article className="chef-card">
              ...
              <div className="chef-dynamic-row chef-step-row">
                <span className="chef-step-index">1</span>
                <textarea rows="3" defaultValue="Describe this step in detail..." />
              </div>
            </article>
